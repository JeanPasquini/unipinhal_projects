...
CREATE TABLE `vendas` (
  ...
  CONSTRAINT `fk_num_nf` FOREIGN KEY (`num_nf`) REFERENCES `notas_fiscais` (`num_nf`) ON UPDATE NO ACTION
...
INSERT INTO `vendas` VALUES (2222,5555,100,1500),(2222,6666,100,500);
